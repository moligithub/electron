...
((mod) => {
  ...
  var replaceDialog = `
    <div class="row find">
      ...
      <input id="CodeMirror-find-field" type="text" class="CodeMirror-search-field" placeholder="请输入内容" />
      <span class="CodeMirror-search-hint"></span>
      <span class="CodeMirror-search-count"></span>
    </div>
    <div class="row replace">
      <label for="CodeMirror-replace-field">替换为:</label>
      <input id="CodeMirror-replace-field" type="text" class="CodeMirror-search-field" placeholder="请输入替换内容" />
    </div>
    <div class="buttons">
      <button>上一个</button>
      <button>下一个</button>
  ...
  var findDialog = `
    <div class="row find">
      <label for="CodeMirror-find-field">查找:</label>
      <input id="CodeMirror-find-field" type="text" class="CodeMirror-search-field" placeholder="请输入查找内容" />
      <span class="CodeMirror-search-hint"></span>
      <span class="CodeMirror-search-count"></span>
    </div>
    <div class="buttons">
  ...
  let updateCount = (cm) => {
    ...
    let countText = count === 1 ? '1 条记录' : count + ' 条记录';
